...
public class TravClimber extends SubsystemBase {
    private static TravClimber instance;
    ...
    public static synchronized TravClimber getInstance() {
        if (instance == null) {
            instance = new TravClimber();
        }
        return instance;
    }
